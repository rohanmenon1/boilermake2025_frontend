...
export declare class MenuClassComponent extends React_2.Component<MenuProps, MenuState> {
    ...
    static propTypes: {
        ...
        openOnClick: default_2.Requireable<boolean>;
...
export declare class MenuItem extends React_2.Component<MenuItemProps, {}> {
    ...
    static propTypes: {
        ...
        cssClass: default_2.Requireable<string>;
        cssStyle: default_2.Requireable<object>;
        render: default_2.Requireable<any>;
        linkRender: default_2.Requireable<any>;
        contentRender: default_2.Requireable<any>;
        data: default_2.Requireable<any>;
        separator: default_2.Requireable<boolean>;
    };
    /**
     * @hidden
     */
...
export declare class MenuItemArrow extends React_2.Component<MenuItemArrowProps, {}> {
     ...
     */
    static propTypes: {
        itemId: default_2.Requireable<string>;
        dir: default_2.Requireable<string>;
        verticalMenu: default_2.Requireable<boolean>;
    };
    /**
     * @hidden
     */
...
export declare class PanelBar extends React_2.Component<PanelBarProps, PanelBarState> {
    ...
    static propTypes: {
        ...
        expanded: default_2.Requireable<(string | null | undefined)[]>;
        focused: default_2.Requireable<string>;
        expandMode: default_2.Requireable<string>;
        className: default_2.Requireable<string>;
        keepItemsMounted: default_2.Requireable<boolean>;
        onSelect: default_2.Requireable<(...args: any[]) => any>;
        style: default_2.Requireable<object>;
    };
    /**
...
export declare class PanelBarItem extends React_2.PureComponent<PanelBarItemProps, PanelBarItemState> {
    ...
    static propTypes: {
        ...
        expanded: default_2.Requireable<boolean>;
        disabled: default_2.Requireable<boolean>;
        onSelect: default_2.Requireable<(...args: any[]) => any>;
        selected: default_2.Requireable<boolean>;
        level: default_2.Requireable<number>;
        title: default_2.Requireable<NonNullable<string | default_2.ReactElementLike | null | undefined>>;
        id: default_2.Requireable<NonNullable<string | number | null | undefined>>;
        focused: default_2.Requireable<boolean>;
        keepItemsMounted: default_2.Requireable<boolean>;
    };
    /**
     * @hidden
...
export declare class TabStripClassComponent extends React_2.Component<TabStripProps, TabStripStateProps, {}> {
    ...
    static propTypes: {
        ...
        style: default_2.Requireable<object>;
        tabContentStyle: default_2.Requireable<object>;
        tabPosition: default_2.Requireable<string>;
...
export declare class TabStripNavigationItem extends React_2.Component<TabStripNavigationItemProps, {}> {
     ...
     */
    static propTypes: {
        active: default_2.Requireable<boolean>;
        disabled: default_2.Requireable<boolean>;
        index: default_2.Requireable<number>;
        onSelect: default_2.Requireable<(...args: any[]) => any>;
        title: default_2.Requireable<NonNullable<string | default_2.ReactElementLike | null | undefined>>;
        first: default_2.Requireable<boolean>;
        last: default_2.Requireable<boolean>;
    };
    /**
     * @hidden
     */
...
export declare class TabStripTab extends React_2.Component<TabStripTabProps, {}> {
    ...
    static propTypes: {
        disabled: default_2.Requireable<boolean>;
        contentClassName: default_2.Requireable<string>;
        children: default_2.Requireable<NonNullable<default_2.ReactNodeLike>>;
        title: default_2.Requireable<NonNullable<default_2.ReactNodeLike>>;
    };
    /**
     * @hidden
     */
...
export declare class TileLayout extends React_2.Component<TileLayoutProps, TileLayoutState> {
    ...
    static propTypes: {
        ...
        className: default_2.Requireable<string>;
        dir: default_2.Requireable<string>;
        gap: default_2.Requireable<object>;
        columns: default_2.Requireable<number>;
        columnWidth: default_2.Requireable<NonNullable<string | number | null | undefined>>;
        rowHeight: default_2.Requireable<NonNullable<string | number | null | undefined>>;
        dataItemKey: default_2.Requireable<string>;
        items: default_2.Requireable<any[]>;
        positions: default_2.Requireable<any[]>;
        autoFlow: default_2.Requireable<string>;
        onReposition: default_2.Requireable<(...args: any[]) => any>;
        ignoreDrag: default_2.Requireable<(...args: any[]) => any>;
    };
    /**
     * @hidden
     */
