...
const c = {
  ...
  y(C);
  const { className: t, style: u } = a, i = r.useRef(null), k = r.useCallback(() => {
  ...
  const s = r.useMemo(() => a.size || l.size, [a.size]), e = r.useMemo(() => a.themeColor || l.themeColor, [a.themeColor]), o = r.useMemo(() => a.type || l.type, [a.type]), g = r.useMemo(
    () => v(
      "k-loader",
      {
        "k-loader-sm": s === "small",
        "k-loader-md": s === "medium",
        "k-loader-lg": s === "large",
  ...
  return m.fill(0, 0, c[o]), /* @__PURE__ */ r.createElement("div", { className: g, style: u }, /* @__PURE__ */ r.createElement("div", { className: "k-loader-canvas" }, m.map((N, f) => /* @__PURE__ */ r.createElement("span", { key: f, className: "k-loader-segment" }))));
});
d.propTypes = {
  className: n.string,
  style: n.object,
  type: n.oneOf(["pulsing", "infinite-spinner", "converging-spinner"]),
